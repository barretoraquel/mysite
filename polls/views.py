...
def room(request, pk):
    ...
    room_messages = room.message_set.all().order_by('-created')    #go back to this
    ...
    if request.method == "POST":
        ...
        room.participants.add(request.user) # add the user making the request to the participants list
